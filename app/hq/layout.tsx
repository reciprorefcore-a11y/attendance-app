...
export default function HqLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!user) return <main style={{ padding: 24 }}>ログインが必要です</main>;
  if (!profile) return <main style={{ padding: 24 }}>権限確認中</main>;
  if (profile.role !== "admin") return <main style={{ padding: 24, color: "#991B1B" }}>本部管理者権限が必要です</main>;
