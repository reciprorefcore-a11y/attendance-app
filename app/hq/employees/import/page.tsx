    ...
    try {
      for (const row of rows) {
        const employeeRef = await addDoc(collection(db, "employees"), {
          ...
          employeeType: row.employmentType === "full_time" ? "fullTime" : "partTime",
          payrollType: row.employmentType === "full_time" ? "fixed" : "hourly",
          clockEnabled: row.employmentType !== "full_time",
          status: "active",
